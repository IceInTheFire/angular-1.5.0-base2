 ...
 */
tinymce.PluginManager.add('autoMatch',function(editor){
    var id = "autoMacth";
    // console.log("ok");
    editor.addButton("autoMatch",{
        icon: 'autoMatch',
        tooltip: '自动匹配',
        image : '/lib/tinymce/widgetPlugins/imageupload/img/icon-autoMatch.png',
        onClick:showDialog
    });
            ...
            body:[
                {
                    ...
                    text: '福利购',
                    onclick: function (e) {
                        editor.isAutoMatch = true;
                        editor.getParams = {
                            itemType: 2,
                            // itemKeyWordList: html,
                            itemKeyWordList: '',
                        }
                        this.parent().parent().close();
                        editor.settings.matchItem.getitemdetailCallback(editor,getDatas(editor,editor));
