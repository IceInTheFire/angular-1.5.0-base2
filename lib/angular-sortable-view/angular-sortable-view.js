                ...
                function onMousedown(e){
                    ...
                    if(helper){
                        ...
                        clone.addClass('sv-helper').css({
                            'left': clientRect.left - modalLeft + document.body.scrollLeft + 'px',
                            'top': clientRect.top - modalTop + document.body.scrollTop + 'px',
